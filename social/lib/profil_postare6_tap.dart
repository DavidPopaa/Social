...
import 'package:social/img_postare6.dart';
import 'package:social/profile_label.dart';

class profil_postare6_tap extends StatelessWidget {
  @override
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [Text('Miguel Arguibide')],
            ),
          ),
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [Text('Despre: S-a alaturat pe 12.05.2001')],
            ),
          ),
        ],
      ),
